        ...
        <section className="py-10 px-6 bg-slate-50">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/services/workday-implementation-specialist" className="bg-white border border-blue-200 text-blue-700 font-semibold px-4 py-2 rounded-lg text-sm hover:bg-blue-50 transition-colors">
                Workday HCM Implementation →
              </Link>
              <Link href="/services/project-manager-payroll-systems" className="bg-white border border-blue-200 text-blue-700 font-semibold px-4 py-2 rounded-lg text-sm hover:bg-blue-50 transition-colors">
                Payroll Systems PM →
              </Link>
              <Link href="/services/bilingual-implementation-manager" className="bg-white border border-blue-200 text-blue-700 font-semibold px-4 py-2 rounded-lg text-sm hover:bg-blue-50 transition-colors">
                Bilingual PM (EN/FR) →
              </Link>
            </div>
          </div>
